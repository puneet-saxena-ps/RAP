class ZCL_ZFIAP_EP_DATAN_DPC_EXT definition
  public
  inheriting from ZCL_ZFIAP_EP_DATAN_DPC
  create public .
...
CLASS ZCL_ZFIAP_EP_DATAN_DPC_EXT IMPLEMENTATION.
...
**TRY.
*CALL METHOD SUPER->ATTACHSET_GET_ENTITYSET
*  EXPORTING
*    IV_ENTITY_NAME           =
*    IV_ENTITY_SET_NAME       =
*    IV_SOURCE_NAME           =
...
***TRY.
**CALL METHOD SUPER->EP_DATASET_CREATE_ENTITY
**  EXPORTING
**    IV_ENTITY_NAME          =
**    IV_ENTITY_SET_NAME      =
**    IV_SOURCE_NAME          =
...
*
*    INSERT zfiap_ep_data FROM ls_ep_data.
*    IF sy-subrc = 0.
