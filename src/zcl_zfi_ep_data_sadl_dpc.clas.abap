class ZCL_ZFI_EP_DATA_SADL_DPC definition
  public
...
protected section.
  ...
  methods ZFI_CDS_EP_VIEW__CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZFI_EP_DATA_SADL_MPC=>TS_ZFI_CDS_EP_VIEW_SADLTYPE
    raising
  ...
  methods ZFI_CDS_EP_VIEW__GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZFI_EP_DATA_SADL_MPC=>TT_ZFI_CDS_EP_VIEW_SADLTYPE
...
CLASS ZCL_ZFI_EP_DATA_SADL_DPC IMPLEMENTATION.
...
*&* This class has been generated on 15.08.2023 09:18:54 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZFI_EP_DATA_SADL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA zfi_cds_ep_view__create_entity TYPE zcl_zfi_ep_data_sadl_mpc=>ts_zfi_cds_ep_view_sadltype.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zfi_cds_ep_view__get_entity TYPE zcl_zfi_ep_data_sadl_mpc=>ts_zfi_cds_ep_view_sadltype.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZFI_EP_DATA_SADL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA zfi_cds_ep_view__get_entityset TYPE zcl_zfi_ep_data_sadl_mpc=>tt_zfi_cds_ep_view_sadltype.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA zfi_cds_ep_view__update_entity TYPE zcl_zfi_ep_data_sadl_mpc=>ts_zfi_cds_ep_view_sadltype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20230815161853
               iv_uuid              = 'ZFI_EP_DATA_SADL'
