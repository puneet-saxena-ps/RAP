class ZCL_ZFI_CDS_EP_VIEW_SA_MPC definition
  public
...
CLASS ZCL_ZFI_CDS_EP_VIEW_SA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZFI_CDS_EP_VIEW_SADL_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230816053530'.                  "#EC NOTEXT
...
*&---------------------------------------------------------------------*
*    @@TYPE_SWITCH:
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20230816053530'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20230816053530'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'ZFI_CDS_EP_VIEW_SADL' )
